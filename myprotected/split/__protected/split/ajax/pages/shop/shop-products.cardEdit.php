<?php 
	...
	$cardTmp = array(
					...
					'onChange'=>"updateProductCharsForm(".$cardItem['category']['id'].",".json_encode($cardItem['charsGroup']).",".json_encode($cardItem['chars']).",$(this).val());", 
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма редактирования карточки товара #$item_id</h3>";
