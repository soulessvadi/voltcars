<?php /* Smarty version 2.6.27, created on 2013-12-05 13:13:48
         compiled from view.tpl */ ?>
			<div class="r-z-c-filter" id="filtr-wrap">
            	                
            	<div class="r-z-c-f-search top-filtr" id="filtr-1">
                	<form>
                    	<input id="on-materials" class="filtr-form-group" type="text" value="Поиск по материалам" name="on-materials" />
                        <div class="styled-select filtr-form-group">
                            <select class="sampling_changed" >
                                <option  selected="selected" data-skip="1">Название</option>
                        ...
                        <button class="r-z-h-s-create-sm filtr-form-group" type="button">Создать</button>
                ...
                <div class="r-z-c-f-filling top-filtr" id="filtr-2">
                	<form>
                        <div class="r-z-c-f-fil-select-item">
                        	<label for="r-z-c-f-fil-category">Категория</label>
                            <br>
