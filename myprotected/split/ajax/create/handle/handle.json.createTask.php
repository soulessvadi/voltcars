				...
				if($item_id)
				{
					...
					if($RespUser)
					{
						...
						$r_mess = "<p>".$R['name']." ".$R['fname'].", Вы получили новое задание от администратора.</p>
								   ...
								   <p>Перейдиете в админпанель для выполнения: <a href='http://strateg.com.ua/myprotected'>Перейти</a></p>
						...
						$ah->wp_send_letter($R['login'],"support@strateg.com.ua","New STRATEG Task: ".$cardUpd['subject'],$r_mess);
					}
