<?php 
	...
	$letter .= " ".$cardUpd['name']." ".$cardUpd['fname']."! <br> Ваш аккаунт на сайте strateg.com.ua успешно зарегистрирован! <br><hr><br>";
	...
	$ah->wp_send_letter($cardUpd['login'],"support@strateg.com.ua","Успешная авторизация",$letter);
