<?php 
	...
	$select_html = $ah->print_select(
									...
									'name', 
									'acc_cat_id', 
									"reload_banner_cat_products_modal($(this).val(),$id);", 
									array( 'name'=>'-- Категория не выбрана --', 'id'=>0 ),
									'allCatalog',
									'margin-left:25px;',
									''
									);
	$onchange = "reload_search_prod_banner_modal($('#save-search-banner-products').val(),$id);";
	
	$select_html .=  "
			
			<div class='zen-form-item'>
				<label for='save-search-banner-products'>Search key</label><br>
				<div class='zif-wrap'>
                	<input	id='save-search-banner-products' class='my-field' type='text' placeholder='Search key' value='' name='skey' size='25' />
...
<title>BANNER Products SCRIPT</title>
</head>
...
<body>
    ...
    <div class="modalW" id="modalW-1">
        ...
        <div id="reloadAddingBannerProducts"></div>
    </div>
</body>
</html>