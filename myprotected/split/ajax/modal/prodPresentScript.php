<?php 
	...
	$select_html = $ah->print_select(
									...
									'name', 
									'acc_cat_id', 
									"reload_cat_present_products_modal($(this).val(),$id);", 
	...
	$onchange = "reload_search_present_products_modal($('#save-search-present-products').val(),$id);";
	...
	$select_html .=  "
			...
			<div class='zen-form-item'>
				...
				<div class='zif-wrap'>
                	<input	id='save-search-present-products' class='my-field' type='text' placeholder='Search key' value='' name='skey' size='25' />
...
<body>
    ...
    <div class="modalW" id="modalW-3">
        ...
        <div id="reloadAddingProductsPresent"></div>
    </div>
</body>
</html>