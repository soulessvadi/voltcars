<?php 
	...
	$cardItem = $zh->getMobBannerItem($item_id);
	...
	$cardTmp = array(
					 ...
					 'Изображение материала'=>	array( 'type'=>'image_mono','field'=>'file', 			'params'=>array( 'path'=>"/split/files/images/", 'appTable'=>$appTable, 'id'=>$item_id ) ),
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editMobileBanner", 'ajaxFolder'=>'edit', 'appTable'=>$appTable );
