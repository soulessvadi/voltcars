<?php 
	...
	$headParams = array( 'parent'=>$parent, 'alias'=>$alias, 'id'=>$id, 'appTable'=>$appTable, 'type'=>'reasonsPage' );
	
	$data['headContent'] = $zh->getLandingHeader($headParams);
	
	// Get page items
	
	$itemsList = $zh->getReasons($params);

	$totalItems = $zh->getReasons($params,true);
	...
	$tableColumns = array(
						  ...
						  'Контент'				=>	array('type'=>'text',		'field'=>'content'),
