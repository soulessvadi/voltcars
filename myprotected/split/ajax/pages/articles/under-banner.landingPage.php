<?php 
	...
	$itemsList = $zh->getSecondaryBanners($params);

	$totalItems = $zh->getSecondaryBanners($params,true);
	...
	$tableColumns = array(
						  ...
						  'Главный баннер'		=>	array('type'=>'text',		'field'=>'parent_name'),
						  ...
						  'Дата создания'		=>	array('type'=>'date',		'field'=>'dateCreate', 'params'=>array('format'=>'d-m-Y','function'=>'long') ),
