<?php 
	...
	$itemsList = $zh->getContactFormMessages($params);

	$totalItems = $zh->getContactFormMessages($params,true);
	...
	$tableColumns = array(
						  ...
						  'Просмотрено'			=>	array('type'=>'viewed', 		'field'=>'viewed'),
						  'Дата'				=>	array('type'=>'date',		'field'=>'date_created', 'params'=>array( 'format'=>'d-m-Y', 'function'=>'long')),
						  'Просмотр'			=>	array('type'=>'cardView',	'field'=>'Смотреть', 'params'=>array('type' => 'contact_message_view'))
						  );
