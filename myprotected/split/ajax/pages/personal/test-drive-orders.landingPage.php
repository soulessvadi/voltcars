<?php 
	...
	$itemsList = $zh->getTestDriveOrders($params);

	$totalItems = $zh->getTestDriveOrders($params,true);
	...
	$tableColumns = array(
						  ...
						  'Просмотр'			=>	array('type'=>'cardView',	'field'=>'Смотреть', 'params'=>array('type' => 'test_drive_view'))
						  );
