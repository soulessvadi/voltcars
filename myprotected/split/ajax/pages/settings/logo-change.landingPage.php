<?php 
	...
	$headParams = array( 'parent'=>$parent, 'alias'=>$alias, 'id'=>$id, 'appTable'=>$appTable, 'type'=>'logo_admin_head' );
	
	$data['headContent'] = $zh->getLandingHeader($headParams);
	
	// Get page items
	
	$itemsList = $zh->getLogo($params);

	$totalItems = $zh->getLogo($params, true);
	...
	$tableColumns = array(
						  ...
						  'Ширина (px)'		=>	array('type'=>'text',		'field'=>'w'),
						  'Высота (px)'		=>	array('type'=>'text',		'field'=>'h'),
						  'Текущее имя файла'	=>	array('type'=>'text',		'field'=>'file'),
						  'Правильное имя!'		=>	array('type'=>'text',		'field'=>'filename_tmp'),
