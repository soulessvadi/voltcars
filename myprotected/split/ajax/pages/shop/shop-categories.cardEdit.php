<?php 
	...
	$cardTmp = array(
					 ...
					 'Позиция'				=>	array( 'type'=>'input', 	'field'=>'order_id', 		'params'=>array( 'size'=>10, 'hold'=>'Позиция' ) ),
					...
					*/
					'Група характеристик'	=>	array( 'type'=>'select', 	'field'=>'charsGroup', 		'params'=>array( 'list'=>$charsGroups, 
					 																									 'fieldValue'=>'id', 
																														 'fieldTitle'=>'name', 
																														 //'currValue'=>$cardItem['charsGroup']['id'],
																														 'currValue'=>$cardItem['specs_group_id'], 
																														 'onChange'=>"", 
					 ...
					 'Изображение категории'=>	array( 'type'=>'image_mono','field'=>'filename', 		'params'=>array( 'path'=>"/split/files/shop/categories/", 'appTable'=>$appTable, 'id'=>$item_id ) ),
					 
					 'Имя изображения'		=>	array( 'type'=>'hidden',	'field'=>'curr_filename', 	'params'=>array( 'field'=>"filename" ) )*/
					 
					 );

	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editShopCatalogItem", 'ajaxFolder'=>'edit', 'appTable'=>$appTable );
