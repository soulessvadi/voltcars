<?php 
	...
	$itemsList = $zh->getShopChars($params);

	$totalItems = $zh->getShopChars($params,true);
	
	$charGroups = $zh->getCharGroups();
	...
	$filter2_options = array( 
							...
							'Категория характеристик' => array( 'fieldName'=>'M.group_id', 'params' => $charGroupsFilter )  
							);
	...
	$tableColumns = array(
						  ...
						  'Группа'				=>	array('type'=>'text',		'field'=>'group_name'),
						  'Ед. измерения'		=>	array('type'=>'text',		'field'=>'measure'),
