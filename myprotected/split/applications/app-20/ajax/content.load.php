...
<title>Load PRODUCTS List</title>
</head>
...
<body>
	<?php // echo '<pre>'; print_r($tmp_data); echo '</pre>'; ?>
            ...
            <div id="dndArea" class="hidden"></div>
</body>
<?php
