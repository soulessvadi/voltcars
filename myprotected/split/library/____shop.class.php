...
class settingsHelp extends BasicHelp
{
		...
		public function getAllShopProducts($params = array())
		{
			...
			$query = "SELECT M.id, M.hotline, M.name, M.alias, M.sku, M.price, M.block, M.dateCreate, M.dateModify,  C.name as cat_name, C.alias as cat_alias, C.id as cat_id, CP.name as parent_name,
