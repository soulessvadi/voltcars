...
class articlesHelp extends BasicHelp
{
		...
		public function getBanners($params=array(),$typeCount=false)
		{
			...
			if(!$typeCount)
			{
				...
				$query = "SELECT M.id, M.name, M.alias, M.block, M.pos_id, M.dateCreate, M.startPublish, M.finishPublish, 
		...
		// Get secondary banner item
		
		public function getSecondaryBannerItem($id)
		{
			$query = "SELECT M.*, (SELECT name FROM [pre]banners WHERE `id`=M.parent LIMIT 1) as parent_name  FROM [pre]secondary_banners as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getSecondaryBanners($params=array(),$typeCount=false)
		{
			// Filter params
			...
			if(!$typeCount)
			{
				...
				$query = "SELECT M.id, M.name, M.alias, M.block, M.parent, M.dateCreate,
			
						(SELECT name FROM [pre]banners WHERE `id`=M.parent LIMIT 1) as parent_name 
						
						FROM [pre]secondary_banners as M  
		...
		{
			$query = "SELECT id,name FROM [pre]banners WHERE 1 ORDER BY id LIMIT 1000";
			return $this->rs($query);
		}
		...
		// GET TEST DRIVE ORDER
		
		///////////////////////////////////////////
		
		// Get GET TEST DRIVE ORDER item
		
		public function getTestDriveOrderItem($id)
		{
			$query = "SELECT M.* FROM [pre]test_drive_orders as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getTestDriveOrders($params=array(),$typeCount=false)
		{
			// Filter params
			...
			if(!$typeCount)
			{
				...
				$query = "SELECT M.id, M.name, M.phone, M.viewed, M.date_created 
			
						FROM [pre]test_drive_orders as M  
		...
		// Get CONTACT MESSAGE item
		
		public function getContactMessageItem($id)
		{
			$query = "SELECT M.* FROM [pre]contact_form as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getContactFormMessages($params=array(),$typeCount=false)
		{
			// Filter params
			...
			if(!$typeCount)
			{
				...
				$query = "SELECT M.id, M.name, M.email, M.message, M.date_created, M.viewed 
		...
		public function getMobBannerItem($id)
		{
			$query = "SELECT M.* FROM [pre]mobile_banners as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getMobBanners($params=array(),$typeCount=false)
		{
			// Filter params
			...
			if(!$typeCount)
			{
				...
				$query = "SELECT M.id, M.name, M.data, M.block, M.pos_id, M.dateCreate, M.dateCreate, M.file 
			
						FROM [pre]mobile_banners as M  
		...
		public function getReasonsItem($id)
		{
			$query = "SELECT M.* FROM [pre]reasons_to_buy as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getReasons($params=array(),$typeCount=false)
		{
			// Filter params
			...
			if(!$typeCount)
			{
				...
				$query = "SELECT M.id, M.name, M.content, M.dateModify, M.pos_id 
			
						FROM [pre]reasons_to_buy as M  
