...
class settingsHelp extends BasicHelp
{
		...
		public function getLogoItem($id)
		{
			$query = "SELECT M.* FROM [pre]logo as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getLogo($params=array(),$typeCount=false)
		{
			// Filter params
		...
		public function getDesignItem($id)
		{
			$query = "SELECT M.* FROM [pre]design_elem as M WHERE `id`='$id' LIMIT 1";
			$resultMassive = $this->rs($query);
		...
		public function getDesign($params=array(),$typeCount=false)
		{
			// Filter params
