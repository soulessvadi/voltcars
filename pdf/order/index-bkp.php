...
<table style=\"width:150%;\">
	<tr>
		...
		<td>
			Інтернет Магазин \"Strateg Company\" <br />
			04205, г. Киев,<br />
			проспект Оболонский, 21-Б<br />
			ТРЦ «DREAM TOWN»,<br />
			2-й эт., Секция В-80<br />
			тел. (044) 485 22 95 <br />
		</td>
	</tr>
	<tr>
		...
		if($prodData)
		{
			...
			$html .=
				"<tr>
					...
					<td align=\"center\">".$prod['price']." грн.</td>
					<td align=\"center\">".($prod['price']*$product['quant'])." грн.</td>
				</tr>";
		}
	}
